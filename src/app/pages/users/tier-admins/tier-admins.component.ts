...
export class TierAdminsComponent implements OnInit, OnDestroy {
    ...
    getUserData() {
        this.isLoading = true;
        this.usersService.usersControllerGetUsersPage(undefined, undefined, 'TIER_ADMIN').subscribe(users => {
    ...
    async gotoUserDetail(element: User) {
        ...
        this.router.navigate(['tier-admin-detail'], { queryParams: { id: id }, relativeTo: this.route, state: userData });
    }
