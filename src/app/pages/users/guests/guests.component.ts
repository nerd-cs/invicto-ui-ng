...
export class GuestsComponent implements OnInit {
    ...
    getUserData() {
        this.isLoading = true;
        this.usersService.usersControllerGetUsersPage(undefined, undefined, 'GUEST').subscribe(users => {
    ...
    async gotoUserDetail(element: User) {
        ...
        this.router.navigate(['guest-detail'], { queryParams: { id: id }, relativeTo: this.route, state: userData });
    }
