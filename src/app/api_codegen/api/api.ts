...
export const APIS = [AccessGroupService, AccountService, AuthService, ControllerService, DoorService, HolidayService, LocationService, ScheduleService, UsersService, ZoneService];
